...
and typeof_bop env bop e1 e2 =
  ...
  | Geq, TFloat, TInt -> TBool
  | Geq, TInt, TFloat -> TBool
  | _ -> failwith bop_err
...
and eval_bop bop e1 e2 = 
  ...
  (*Subtract, Float Float*)
  | FSubtr, Float a, Float b -> Float (round_dfrac 2 (a -. b))
  (*Divide, Float Float*)
  | FDivd, Float a, Float b -> Float (round_dfrac 2 (a /. b))
  (*Mult, Float Float*)
  ...
  | Geq , Float a, Int b -> Bool (a >= (float b))
  | Geq , Int a, Float b -> Bool ((float a) >= b)
